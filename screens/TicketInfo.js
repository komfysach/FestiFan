...
const TicketInfo = ({ route, navigation }) => {
    ...
    function editOrder(action, infoId, price) {
        let orderList = orderItems.slice()
        let item = orderList.filter(a => a.infoId === infoId)
    ...
    function getOrderQty(infoId) {
        let orderItem = orderItems.filter(a => a.infoId === infoId)
            ...
            <View style={{ flexDirection: 'row' }}>
                ...
                >
                    <View style={{
                        ...
                        <Text style={{ ...FONTS.h3 }}>{ticketInfo?.name}</Text>
    ...
    function renderTicketInfo() {
        return (
            ...
            >
                {
                    ticketInfo?.info.map((item, index) => (
                        <View
                            key={`info-${index}`}
                            ...
                            <View style={{ height: SIZES.height * 0.35 }}>
                                ...
                                >
                                    <TouchableOpacity
                                        ...
                                        onPress={() => editOrder("-", item.infoId, item.price)}
                                    >
                                    ...
                                    >
                                        <Text style={{ ...FONTS.h2 }}>{getOrderQty(item.infoId)}</Text>
                                    </View>
                                    <TouchableOpacity
                                        style={{
                                            width: 50,
